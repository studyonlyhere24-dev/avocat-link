...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join Avocat-Link as a client or a vetted lawyer. End-to-end encrypted from day one." },
    ],
  }),
});
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="relative hidden md:block overflow-hidden">
        <img src={scalesImg} alt="Scales of justice" className="absolute inset-0 h-full w-full object-cover" />
